...
class MainWindowToolbarItemExportButton: NSButton {
    ...
    func setupButtonMenu() {
        ...
        menuItemExportProfile.identifier = NSUserInterfaceItemIdentifier("exportProfile")
    ...
    override func mouseEntered(with event: NSEvent) {
        if self.isEnabled, let parent = self.superview, let toolbarItemExport = parent as? MainWindowToolbarItemExport {
