...
class ValueImportProcessorSystemExtensionPolicyBundleIdentifier: ValueImportProcessor {

    init() {
        super.init(identifier: "com.apple.syspolicy.system-extension-policy.SystemExtensionsBundleIdentifier")
    }
